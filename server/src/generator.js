...
async function generateValidationReport(name, idea, industry, country, budget, businessModel) {
...
async function generateWithGemini(apiKey, name, idea, industry, country, budget, businessModel) {
...
function generateRuleBased(name, idea, industry, country, budget, businessModel) {
