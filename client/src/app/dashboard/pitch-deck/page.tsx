      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center max-w-4xl mx-auto">
            ...
            {/* Slide Viewer */}
            <div className="w-full min-h-[300px] md:aspect-video bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-200 rounded-2xl shadow-2xl relative overflow-hidden flex flex-col p-6 md:p-12 transition-all duration-500 animate-in fade-in zoom-in-95">
              ...
              {/* Header */}
              <div className="text-[10px] md:text-xs font-bold text-amber-500 uppercase tracking-widest mb-6 md:mb-12">
                ...
                {data.slides.map((_: any, idx: number) => (
                  <button
                    ...
                    className={cn(
                      ...
                      idx === currentSlide ? "bg-amber-500 w-8" : "bg-white/20 hover:bg-white/40"
                    )}
                  />
                ))}
              </div>
