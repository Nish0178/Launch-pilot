  ...
  return (
    <DashboardLayout>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900 mb-2">Competitor Intelligence</h1>
          <p className="text-zinc-500">Analysis of existing players and market gap opportunities.</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        {/* Comparison Table */}
        <Card className="bg-zinc-50/50 border-zinc-200 overflow-hidden">
            ...
            <Table>
              <TableHeader className="bg-zinc-50">
                <TableRow className="border-zinc-200 hover:bg-transparent">
                  <TableHead className="text-zinc-700 font-bold">Competitor</TableHead>
                  <TableHead className="text-zinc-700 font-bold">Key Strengths</TableHead>
                  <TableHead className="text-zinc-700 font-bold">Major Weaknesses</TableHead>
                  <TableHead className="text-zinc-700 font-bold">Pricing Model</TableHead>
                  <TableHead className="text-zinc-700 font-bold">Winning Edge</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {competitors.map((comp: any, i: number) => (
                  <TableRow key={i} className="border-zinc-200 hover:bg-zinc-50 transition-colors">
                    <TableCell className="font-bold text-zinc-900 py-6">
                    ...
                    <TableCell className="text-zinc-700 text-sm">{comp.pricing}</TableCell>
                    <TableCell className="text-amber-500 text-sm italic font-medium">"{comp.advantage}"</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div key={i} className="p-4 rounded-xl bg-zinc-50 border border-zinc-200">
                  <h4 className="text-zinc-900 font-bold text-sm mb-1 flex items-center gap-2">
                    <PlusCircle className="w-4 h-4 text-emerald-400" />
                    {gap.title}
                  </h4>
                  <p className="text-xs text-zinc-500 leading-relaxed">{gap.desc}</p>
                </div>
              ))}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div key={i} className="p-4 rounded-xl bg-zinc-50 border border-zinc-200">
                  ...
                  <p className="text-xs text-zinc-500 leading-relaxed">{risk.desc}</p>
                </div>
              ))}
            </CardContent>
          </Card>
