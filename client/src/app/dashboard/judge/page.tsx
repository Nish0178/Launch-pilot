  ...
  return (
    <DashboardLayout>
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {/* Header */}
        <div className="flex flex-col items-center justify-center text-center p-8 bg-gradient-to-b from-indigo-900/50 to-zinc-900/50 border border-amber-500/20 rounded-3xl relative overflow-hidden">
          ...
          <h1 className="text-3xl font-black text-zinc-900 tracking-tight mb-2">Hackathon Judge View</h1>
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
            {/* Step 1 */}
            <div className="bg-zinc-50/80 border border-zinc-200 rounded-2xl p-6 relative z-10 hover:border-amber-500/50 transition-colors">
              <div className="text-xs font-bold text-zinc-500 mb-3 uppercase tracking-wider">Step 1</div>
              <Terminal className="w-8 h-8 text-zinc-700 mb-4" />
              <h3 className="font-semibold text-zinc-900 mb-1">User Input</h3>
              <p className="text-xs text-zinc-500">Captures startup idea, budget, and market via Next.js client.</p>
            </div>
            ...
            {/* Step 2 */}
            <div className="bg-zinc-50/80 border border-amber-500/30 rounded-2xl p-6 relative z-10 shadow-[0_0_30px_rgba(99,102,241,0.1)]">
              <div className="text-xs font-bold text-amber-500 mb-3 uppercase tracking-wider">Step 2</div>
              <Code2 className="w-8 h-8 text-amber-500 mb-4" />
              <h3 className="font-semibold text-zinc-900 mb-1">Prompt Builder</h3>
              <p className="text-xs text-zinc-500">Express.js constructs robust, role-playing prompt files.</p>
            </div>

            {/* Step 3 */}
            <div className="bg-indigo-900/40 border border-amber-500/50 rounded-2xl p-6 relative z-10 shadow-[0_0_30px_rgba(99,102,241,0.2)]">
              ...
              <h3 className="font-semibold text-zinc-900 mb-1">Gemini 2.5 Pro</h3>
              <p className="text-xs text-zinc-500">Processes prompt and returns deterministic JSON schema.</p>
            </div>

            {/* Step 4 */}
            <div className="bg-zinc-50/80 border border-amber-500/30 rounded-2xl p-6 relative z-10">
              <div className="text-xs font-bold text-amber-500 mb-3 uppercase tracking-wider">Step 4</div>
              <Bot className="w-8 h-8 text-amber-500 mb-4" />
              <h3 className="font-semibold text-zinc-900 mb-1">Multi-Agent</h3>
              <p className="text-xs text-zinc-500">Simulates VC, Mentor, and Competitor personas simultaneously.</p>
            </div>

            {/* Step 5 */}
            <div className="bg-zinc-50/80 border border-emerald-500/30 rounded-2xl p-6 relative z-10">
              ...
              <h3 className="font-semibold text-zinc-900 mb-1">JSON Parsing</h3>
              <p className="text-xs text-zinc-500">Stores report in SQLite via Prisma for client consumption.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto space-y-6 pt-8 border-t border-zinc-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#0D1117] border border-zinc-200 rounded-2xl p-6 font-mono text-sm overflow-hidden">
              <div className="flex items-center gap-2 mb-4 border-b border-zinc-200 pb-4">
                <div className="w-3 h-3 rounded-full bg-rose-500" />
                <div className="w-3 h-3 rounded-full bg-amber-500" />
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="text-zinc-500 ml-2">founderBoardroomPrompt.ts</span>
              </div>
            ...
            <div className="bg-[#0D1117] border border-zinc-200 rounded-2xl p-6 font-mono text-sm overflow-hidden">
              <div className="flex items-center gap-2 mb-4 border-b border-zinc-200 pb-4">
                ...
                <div className="w-3 h-3 rounded-full bg-amber-500" />
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="text-zinc-500 ml-2">digitalTwinPrompt.ts</span>
              </div>
              ...
              <div className="text-zinc-700 ml-4 mt-2">{'{'}</div>
              <div className="text-zinc-700 ml-8">"growthProbability": number (0-100),</div>
              <div className="text-zinc-700 ml-8">"revenueProjection": {'{'}...{'}'}</div>
              <div className="text-zinc-700 ml-4">{'}'}</div>
              <div className="text-emerald-400 mt-2">{'}'}</div>
            </div>
          </div>
        </div>
