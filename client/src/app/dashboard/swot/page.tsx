...
export default function SWOTAnalysisPage() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">SWOT Analysis</h1>
        <p className="text-slate-500">Strategic evaluation of Internal and External factors affecting your startup.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Strengths */}
        <Card className="bg-slate-50/50 border-slate-200 border-t-4 border-t-emerald-500">
          <CardHeader>
        ...
        {/* Weaknesses */}
        <Card className="bg-slate-50/50 border-slate-200 border-t-4 border-t-rose-500">
          <CardHeader>
        ...
        {/* Opportunities */}
        <Card className="bg-slate-50/50 border-slate-200 border-t-4 border-t-blue-500">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            {swot?.opportunities?.map((o: string, i: number) => (
              <div key={i} className="flex gap-3 p-4 rounded-xl bg-blue-500/5 border border-blue-500/10">
        ...
        {/* Threats */}
        <Card className="bg-slate-50/50 border-slate-200 border-t-4 border-t-amber-500">
          <CardHeader>
