    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
            <Card className="print-card bg-white text-slate-900 shadow-2xl overflow-hidden border-none min-h-[1000px] p-12">
                <div className="flex justify-between items-start mb-16 border-b border-slate-100 pb-8">
                    <div>
                        <h2 className="print-title text-4xl font-black tracking-tighter text-slate-900 mb-2">LaunchPilot AI</h2>
                ...
                <div className="space-y-12">
                    ...
                    <div className="pt-12 border-t border-slate-100">
                         <h3 className="print-title text-xl font-bold text-slate-800 mb-6">Initial Milestones</h3>
                         <div className="grid grid-cols-1 gap-4">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3">
                                    ...
                                    <span className="print-text text-slate-700 font-medium">{milestone}</span>
                                </div>
                            ))}
                         </div>
                    </div>
