...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[20%] left-1/4 -translate-x-1/2 w-[500px] h-[500px] bg-blue-600/10 blur-[120px] rounded-full -z-10" />
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="mb-8 text-center flex flex-col items-center">
          ...
          <p className="text-slate-500 mt-2 text-sm">Start validating your startup ideas instantly</p>
        </div>
